...
1000.times do |x|
  join_listing = JoinListing.create!(user_id: User.all[x].id, item_id: Item.first.id, selling: [true, false].sample, amount_min: 0, amount_max: 1000, start_date: DateTime.now - 1.day, end_date: DateTime.now + 1.day)
end
